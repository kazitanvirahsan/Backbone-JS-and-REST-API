...
{   
     ...
     */  
    public function save($articleObj) {
        try 
        {
            // store article record
            $article = R::dispense('articles');
            $article->article_title = (string)$articleObj->article_title;
            $article->article_url = (string)$articleObj->article_url;
            $article->article_date = (string)'2012-07-10 00:00:00';
            //$article->article_date = (string)$articleObj->article_date;
            $id = R::store($article);
            return $id;
        } catch (Exception $e) 
        {
